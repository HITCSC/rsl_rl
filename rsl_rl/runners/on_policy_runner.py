...
from rsl_rl.modules import ActorCritic, EncActorCritic,ActorCriticRecurrent, EncVelActorCritic,EncDreamWAQActorCritic,resolve_rnd_config, resolve_symmetry_config
...
class OnPolicyRunner:
    ...
    def _construct_algorithm(self, obs) -> PPO:
        ...
        actor_critic: ActorCritic | ActorCriticRecurrent | EncActorCritic | EncVelActorCritic | EncDreamWAQActorCritic = actor_critic_class(
