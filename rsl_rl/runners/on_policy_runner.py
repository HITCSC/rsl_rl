...
from rsl_rl.modules import ActorCritic, ActorCriticRecurrent, CNNActorCritic, resolve_rnd_config, resolve_symmetry_config
...
class OnPolicyRunner:
    ...
    def _construct_algorithm(self, obs) -> PPO:
        ...
        actor_critic: ActorCritic | ActorCriticRecurrent | CNNActorCritic = actor_critic_class(
