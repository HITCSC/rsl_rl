...
from rsl_rl.modules import ActorCritic, ActorCriticCNN, ActorCriticRecurrent, EncActorCritic
...
class PPO:
    ...
    policy: ActorCritic | ActorCriticRecurrent | ActorCriticCNN | EncActorCritic
